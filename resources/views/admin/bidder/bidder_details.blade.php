...
@section('content')
    ...
    <div class="card-body px-4 py-4">
        ...
        <table class="table table-bordered table-striped align-middle text-sm">
            <tbody>
                <tr><th class="w-25">Type</th><td>{{ $bidder->type == 1 ? 'Company' : 'Individual' }}</td></tr>
                <tr><th>Full Name</th><td>{{ $bidder->full_name }}</td></tr>
                <tr><th>Email</th><td>{{ $bidder->email_address }}</td></tr>
                <tr><th>Phone</th><td>{{ $bidder->phone_number }}</td></tr>
                <tr><th>Country</th><td>{{ $bidder->country }}</td></tr>

                @if ($bidder->type == 1)
                    {{-- Company Info --}}
                    <tr><th>Company Name</th><td>{{ $bidder->company_name }}</td></tr>
                    <tr><th>Registration Number</th><td>{{ $bidder->registration_number }}</td></tr>
                    <tr><th>Director Name</th><td>{{ $bidder->director_name }}</td></tr>
                    <tr><th>Director Email</th><td>{{ $bidder->director_email }}</td></tr>
                    <tr><th>Director Phone</th><td>{{ $bidder->director_phone }}</td></tr>
